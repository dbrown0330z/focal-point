...
function Stepper({ step }: { step: Step }) {
  return (
    ...
    <div className="flex items-center gap-0" style={{ width: '60%', minWidth: 280 }}>
...
function UploadStep({
  ...
  file, preview, title, onFileChange, onTitleChange, fullCategoryIds,
}: UploadStepProps) {
...
function LibraryStep({ images, selectedId, categoryId, categories, onSelect, onCategorySelect, fullCategoryIds }: LibraryStepProps) {
...
export default function SubmitModal({
  ...
  categories, libraryImages, fullCategoryIds = [],
}: SubmitModalProps) {
